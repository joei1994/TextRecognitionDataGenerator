...
def main():
    ...
    """
    ### write_dict() //TODO uncomment this when need to write to th.txt
    ...
    if args.use_wikipedia:
       ...
       # strings = create_strings_from_dict(args.length, args.random, args.count, lang_dict)
        strings_dict = create_strings_dict(args.count, lang_dict)
        ...
        for height in [300, 200, 100, 50, 25]:
            ...
            for _ in tqdm(p.imap_unordered(
                ...
                zip(
                    ...
                    [output_path] * string_count,
                    [height] * string_count, #--fit
